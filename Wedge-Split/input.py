...
class input:
    def __init__(self,
                 ...
                 L = 250,                                 # Length of the specimen in mm
                 H = 250,                                 # Height of the specimen in mm
                 D = 250,                                 # Depth of the specimen in mm        
                 groove_depth = 25,                       # Depth of the groove in mm
                 groove_length = 48,                      # Length of the groove in mm
                 notch = 75,                              # Length of the notch in mm
                 notch_width = 4):                        # Width of the notch in mm
